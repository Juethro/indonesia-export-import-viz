...
<head>
    ...
    @vite(['resources/css/app.css','resources/js/app.js', 'resources/js/value.js', 'resources/js/volume.js'])
</head>
<body class="m-0 p-0 ">
<main class="bg-gray-200 h-fit">
    ...
    <div class="mx-[10%] mt-5">
        ...
        <div class="flex justify-between" >
            <div class="max-w-xl w-full h-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                <div class="flex justify-between">
                    <div>
                        <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">32.4k</h5>
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">Pengguna dalam seminggu</p>
                    </div>
                    <div
                ...
                <div class="flex justify-between items-center pt-5">
                    ...
                    <div id="lastDaysdropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <div class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                            <button onclick="getData('2023', 'nilai')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2023</button>
                            <button onclick="getData('2022', 'nilai')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2022</button>
                            <button onclick="getData('2021', 'nilai')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2021</button>
                            <button onclick="getData('2020', 'nilai')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2020</button>
                            <button onclick="getData('2019', 'nilai')" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">2019</button>
                        </div>
                    </div>
                    <a
                        href="#"
